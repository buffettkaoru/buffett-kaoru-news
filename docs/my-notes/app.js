...
const SEED_DATA = [
    ...
    // 👨‍👩‍👧 家族の思い出
    { category: "family", text: "母・ヒサコ:56才までトロントで働いていた" },
    { category: "family", text: "母・ヒサコ:44才からゲームセンター。\nその前は池田建具で3年、8時〜13時の5時間勤務" },
    ...
    { category: "family", text: "倉重ヒサコ(母)\n要介護1 / スマホ: 090-5934-3463\n住所: 東京都中央区佃2丁目11-6 クレストタワー3203(〒104-0051)" },
